...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ir,depthTest:!1,depthWrite:!1})}function CS(){return new ui({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Fv(),fragmentShader:`
		...
		`,blending:ir,depthTest:!1,depthWrite:!1})}function TS(){return new ui({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Fv(),fragmentShader:`
